...
namespace Leap.Unity {
  ...
  public class CapsuleHand : IHandModel {
    ...
    private static Color[] _leftColorList = { Color.blue }; //new Color(0.0f, 0.0f, 1.0f), new Color(0.2f, 0.0f, 0.4f), new Color(0.0f, 0.2f, 0.2f) 
        private static Color[] _rightColorList = { Color.red }; //new Color(1.0f, 0.0f, 0.0f), new Color(1.0f, 1.0f, 0.0f), new Color(1.0f, 0.5f, 0.0f)
